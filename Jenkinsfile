pipeline {
    ...
    stages {
        ...
        stage("OWASP vulnerability scanner") {
            steps {
                script {
                    dependencyCheck additionalArguments: '--scan ./ --disableYarnAudit --disableNodeAudit --nvdApiKey f9c669af-b15f-4487-9d6d-d930c8f1b7a4 --threads=4', odcInstallation: 'DP-Check'
